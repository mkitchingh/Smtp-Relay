...
Current release: [https://github.com/mkitchingh/Smtp-Relay/releases/download/v1.5/SmtpRelaySetup.exe](https://github.com/mkitchingh/Smtp-Relay/releases/download/v1.5.1/SmtpRelaySetup.exe
)
